...
enum class Instruction: uint8_t
{
	...
	TXPARAM = 0xb0,           ///< load transaction parameter (EIP-8141)
	FRAMEDATALOAD,            ///< load frame calldata word (EIP-8141)
	...
	SIGDATACOPY,              ///< copy ARBITRARY signature bytes to memory (EIP-8141)
